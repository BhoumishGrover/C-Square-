  ...
  const features = [
    {
      icon: Globe,
      title: 'Transparency',
      description: 'Every carbon credit is fully traceable on the blockchain, ensuring complete transparency.',
    },
    {
      icon: Shield,
      title: 'Security',
      description: 'Secure, immutable records protected by cutting-edge blockchain technology.',
    },
    {
      icon: Coins,
      title: 'Tokenization',
      description: 'Carbon credits are tokenized as NFTs, making them tradeable and verifiable.',
    },
    {
      icon: Recycle,
      title: 'Sustainability',
      description: 'Supporting verified environmental projects that make a real impact.',
    },
  ];
  ...
  const steps = [
    {
      ...
      description: 'Carbon offset projects are rigorously verified by certified third parties.',
    },
    {
      number: '02',
      title: 'Credits Tokenized',
      description: 'Each verified credit is minted as a unique NFT on the blockchain.',
    },
    {
      number: '03',
      title: 'Companies Purchase',
      description: 'Organizations buy tokens directly through their crypto wallets.',
    },
    {
      number: '04',
      title: 'Retire & Certify',
      description: 'Tokens are burned upon retirement, creating permanent certificates.',
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              C² revolutionizes carbon offsetting by bringing transparency, security, and trust 
              to environmental impact. Every credit is verified, tokenized, and permanently 
            ...
            {sampleCredits.map((credit) => (
              <Card key={credit.id} className="card-marketplace">
                ...
                <CardContent className="p-6">
                  <h3 className="font-semibold text-lg mb-2">{credit.project}</h3>
      ...
      <section className="py-20 bg-accent-gradient">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-accent-foreground/80 max-w-2xl mx-auto mb-12">
            Together, we're building a sustainable future through verified carbon offsetting 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-accent-foreground/80">
                Supporting reforestation, renewable energy, and conservation initiatives worldwide.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-accent-foreground/80">
                Creating jobs and supporting local communities through sustainable development.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-accent-foreground/80">
                Providing transparent, verifiable data on environmental impact and progress.
              </p>
            </div>
          </div>
        </div>
