...
const Explorer = () => {
  ...
  const filteredCredits = retiredCredits.filter(
    (credit) =>
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Search and verify retired carbon credits on the public ledger. Every
            retirement is transparent and permanently recorded.
          </p>
        </div>
              ...
              {filteredCredits.length > 0 ? (
                <>
                  <div className="text-sm text-muted-foreground mb-4">
                    Found {filteredCredits.length} retired credit
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="mt-4 p-3 border rounded-lg">
                              ...
                              <div className="space-y-1 text-xs text-muted-foreground">
                                <div>
                                  ✓ Project verified by {credit.verifier}
                                </div>
