...
const Dashboard = () => {
  const [userType] = useState("buyer"); // For demo, switch to 'verifier' to see verifier view
                    ...
                    <td className="p-3">
                      <div>
                        <div className="font-medium">
                          {project.soldCredits.toLocaleString()} /{" "}
                          {project.totalCredits.toLocaleString()}
                        </div>
                        <div className="text-sm text-muted-foreground">
                          {Math.round(
                            (project.soldCredits / project.totalCredits) * 100
                          )}
                          % sold
                        </div>
                      </div>
