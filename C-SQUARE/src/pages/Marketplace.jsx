...
const Marketplace = () => {
  ...
  const filteredCredits = carbonCredits.filter((credit) => {
    ...
    const matchesCountry =
      selectedCountry === "all" || credit.country === selectedCountry;
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Browse and purchase verified carbon credits from environmental
            projects worldwide.
          </p>
        </div>
        ...
        <div className="mb-6">
          <p className="text-muted-foreground">
            Showing {filteredCredits.length} of {carbonCredits.length} carbon
            credit projects
          </p>
        </div>
                  ...
                  <div className="space-y-2 mb-4 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {credit.tonsAvailable.toLocaleString()} tons
                      </span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="text-right">
                        ...
                        <div className="font-semibold">
                          $
                          {(
                            credit.pricePerTon * credit.tonsAvailable
                          ).toLocaleString()}
                        </div>
                      </div>
                    </div>
